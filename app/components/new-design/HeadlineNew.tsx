    ...
    <section className="mx-auto max-w-[1440px] px-5 py-20 sm:px-8 lg:px-12 lg:py-28">
      ...
      <Reveal className="border-b border-line pb-5">
        <div className="flex items-center gap-3">
          ...
          <span className="font-mono text-[11px] font-medium uppercase tracking-[0.25em] text-white">
            Mobile engineer / Android / iOS / AI
          </span>
        </div>
      </Reveal>
      ...
      <Reveal delay={80}>
        <h2 className="mt-10 font-display font-black uppercase leading-[0.9] tracking-[-0.02em] text-[clamp(2.75rem,11.5vw,10.5rem)]">
          <span className="block text-white hover:text-zinc-400 transition-all">Native</span>
          <span className="block text-accent text-shimmer">Mobile</span>
          <span className="block text-white hover:text-zinc-400 transition-all">Meets</span>
          <span className="block text-accent text-shimmer">Agentic AI</span>
      ...
      <div className="mt-12 flex flex-col gap-10 lg:flex-row lg:items-end lg:justify-between">
        <Reveal className="max-w-md">
          <p className="font-sans text-base leading-relaxed text-zinc-400">
            I lead mobile features from architecture to release across Android
            and iOS. My work spans streaming AI at New Relic, mobility systems at
            Yulu, and reusable Android architecture at RAAHO.
          </p>
        </Reveal>
